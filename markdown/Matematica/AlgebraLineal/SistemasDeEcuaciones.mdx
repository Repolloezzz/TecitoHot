...
<BComment type='warn'>
    ...
    <div className='flex h-max bg-slate-800 justify-center'>
...
<ChordBox title='Ejemplo de representación paramétrica de un conjunto solución' className='bg-cyan-200/30 border-cyan-700 my-2' chord={true}>
    ...
    <Ltx txt='x=\frac{-1+2t}{3}'/> donde <Ltx txt='y=t'/> \
