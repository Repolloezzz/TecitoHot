...
/**
 * @prop containStyle Estilo del contenedor del video
 * @prop videoStyle Estilo del video
 * @prop title Título del video
 * @prop content Contenido del video
 * @prop props Propiedades de ReactPlayer
 */
...
/**
 * Componente que muestra un video en un contenedor con un botón para verlo en pantalla completa
 * donde la misma activa el AbsoluteContext para mostrar el video en pantalla completa
 */
const VidAbs = ({
  containStyle,
  videoStyle,
