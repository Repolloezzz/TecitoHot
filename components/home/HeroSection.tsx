import { TextDown } from '../global/TextAnimation';
import { PixelIcons } from '../global/Icons';
import { PixelButton } from '../global/Buttons';
...
/**
 * Seccion Hero de la pagina inicio
 * Cuenta con un titulo y un boton
 * al igual que un fondo de animacion
 */
export default function HeroSection({
  ...
  return (
    <section>
      <section
        className={
          'absolute w-full h-full z-10 overflow-hidden -top-16 md:-top-7 lg:top-0 flex flex-col items-center md:justify-center box-border border-slate-700'
        }
      >
        ...
        <p className="w-[90%] lg:w-[60%] xl:w-[50%] md:text-xl text-slate-300 bg-slate-700/40 p-2 text-base lg:text-1.5xl bg xl:text-2xl text-center">
          Un buen tecito te prepara para poder empezar a estudiar, pero si creo
          es mejor el café xd para una despertada y ya si quiere le metes tus
          hojas de coca.
        </p>
        <div
      ...
      <BackgroundTime className={className}/>
    </section>
  );
}
