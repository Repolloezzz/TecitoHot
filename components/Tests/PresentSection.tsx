...
const Present = ({ className, title, children }: context) => {
  return (
    <div
    ...
    >
      <div className="hero-content flex-col">
        ...
        <div className="flex flex-col justify-center items-center gap-2 lg:flex-row lg:gap-5 lg:items-start">{children}</div>
      </div>
    </div>
  );
};
